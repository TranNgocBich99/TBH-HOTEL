...
if(!empty($book)) {
  ?>
    <ul class="nav nav-pills mb-3 mt-5" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="pills-basic-tab" data-toggle="pill" href="#pills-basic" role="tab" aria-controls="pills-home" aria-selected="true">Thông tin cơ bản</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="pills-availability-tab" data-toggle="pill" href="#pills-availability" role="tab" aria-controls="pills-profile" aria-selected="false">Quản lý phòng trống</a>
        </li>
    </ul>
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-availability" role="tabpanel" aria-labelledby="pills-profile-tab">
